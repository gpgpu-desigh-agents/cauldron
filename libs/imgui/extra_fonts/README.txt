...
---------------------------------------
 ...
 See the documentation in binary_to_compressed_c.cpp for instruction on how to use the agent.
 You may find a precompiled version binary_to_compressed_c.exe for Windows instead of demo binaries package (see README).
 The agent optionally used Base85 encoding to reduce the size of _source code_ but the read-only arrays will be about 20% bigger. 
